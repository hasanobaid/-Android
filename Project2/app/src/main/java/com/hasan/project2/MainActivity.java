...
public class MainActivity extends AppCompatActivity
    ...
    protected void onStart() {
        super.onStart();
        Log.d("START", "I'm in on start method");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.d("STOP", "I'm in on Stop method");
    ...
    protected void onPause() {
        super.onPause();
        Log.d("PAUSE", "I'm in on Pause method");
    ...
    protected void onResume() {
        super.onResume();
        Log.d("Resume", "I'm in on Resume method");
    ...
    protected void onRestart() {
        super.onRestart();
        Log.d("RESTART", "I'm in on Restart method");
