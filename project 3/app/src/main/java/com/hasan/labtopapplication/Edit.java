...
public class Edit extends AppCompatActivity {
    ...
    public void initial() {
        ...
        String iComp = intent.getExtras().getString("COMP");
        String iType = intent.getExtras().getString("TYPE");
        int iPrice = intent.getExtras().getInt("PRICE", 0);

        company.setText(iComp);
        type.setText(iType);
    ...
    private class SendPostRequest extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(Edit.this, result, Toast.LENGTH_SHORT).show();
    ...
    public void OnClickSave(View view) {
        ...
        String restUrl = "http://192.168.1.109/project3/update.php";
    ...
    public void OnClickDelete(View view) {
        ...
        String restUrl = "http://192.168.1.109/project3/delete.php";
        if (ContextCompat.checkSelfPermission(this,
                Manifest.permission.INTERNET)
                != PackageManager.PERMISSION_GRANTED) {
